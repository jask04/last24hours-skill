...
Real-time forecasting skill for Codex. It defaults to probability-first answers using Polymarket, Kalshi, X, Reddit, Hacker News, and the web, with strongest support for prediction markets, sports, weather, elections, macro, and event outcomes.
