...
def main():
    ...
    closing_seed_cap = 2 if kalshi_fast_scan else 8 if args.paper_fast_watchlist else 12
        ...
        if not live_sports_mode and preferred_closing_venue != "polymarket":
            try:
                ...
                closing_raw_ka = closing_soon.scan_kalshi_closing_soon(
                    ...
                    max_seeds=2 if kalshi_fast_scan else 8 if args.paper_fast_watchlist else 12,
                    ...
                    stop_after_compatible=1 if kalshi_fast_scan else None,
                )
