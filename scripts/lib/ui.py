...
def show_diagnostic_banner(diag: dict):
    ...
    if IS_TTY:
        ...
        lines.append(f"{Colors.DIM}│{Colors.RESET} {Colors.BOLD}/last24hours v1.0.74 — Source Status{Colors.RESET}                    {Colors.DIM}│{Colors.RESET}")
        ...
        lines.append("┌─────────────────────────────────────────────────────┐")
        lines.append("│ /last24hours v1.0.74 — Source Status                    │")
        lines.append("│                                                     │")
