"""Bird X search client - vendored Twitter GraphQL search for /last24hours v1.0.74.
...
def install_bird() -> Tuple[bool, str]:
    """No-op - Bird search is vendored in v1.0.74, no installation needed.

    Returns:
        Tuple of (success, message).
    """
    if is_bird_installed():
        return True, "Bird search is bundled with /last24hours v1.0.74 - no installation needed."
...
def get_bird_status() -> Dict[str, Any]:
    ...
    return {
        ...
        "can_install": True,  # Always vendored in v1.0.74
    }
