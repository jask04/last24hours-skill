"""Bird X search client - vendored Twitter GraphQL search for /last24hours v2.1.
...
def install_bird() -> Tuple[bool, str]:
    ...
    if is_bird_installed():
        return True, "Bird search is bundled with /last24hours v2.1 - no installation needed."
