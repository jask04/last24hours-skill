#!/usr/bin/env python3
"""Morning briefing generator for last24hours.
...
BRIEFS_DIR = Path.home() / ".local" / "share" / "last24hours" / "briefs"
...
def generate_daily(since: str = None) -> dict:
    ...
    if not topics:
        return {
            "status": "no_topics",
            "message": "No watchlist topics yet. Add one with: last24hours watch add \"your topic\"",
        }
...
def main():
    parser = argparse.ArgumentParser(description="Generate last24hours briefings")
