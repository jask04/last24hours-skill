...
Real-time forecasting and market-watchlist skill for Codex, Claude Code, and Gemini. It defaults to prediction-mode answers and searches the last 24-48 hours across Polymarket, Kalshi, X, Reddit, Hacker News, official National Weather Service data, YouTube, TikTok, Bluesky, and the web.
...
No auth is required for Polymarket or Kalshi public market discovery. NWS weather lookup requires no auth for supported U.S. aliases.
